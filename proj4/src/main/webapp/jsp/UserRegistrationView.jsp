			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="firstName"
						placeholder="First name is required" size="23"
				...
				<tr>
					...
					<td><input type="text" name="lastName"
						placeholder="Last name is required" size="23"
				...
				<tr>
					...
					<td><input type="text" name="login"
						placeholder="Must be Email ID" size="23"
				...
				<tr>
					...
					<td><input type="password" name="password"
						placeholder="Password is required" size="23"
				...
				<tr>
					...
					<td><input type="text" name="dob" readonly="readonly"
						id="datepicker" size="23" placeholder="Date of Birth is required"
